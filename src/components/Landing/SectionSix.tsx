...
const SectionSix = () => {
  return (
    <section className="mt-[204px] flex w-full max-w-max mx-auto rounded-[40px] overflow-hidden">
      ...
      <div className="w-full h-full max-h-[672px] py-10 px-20 bg-[#F2F2F2]">
        <h1 className="h-[66px] text-center text-black text-[64px] font-black font-['Urbanist'] leading-[37.50px]">
          Contact Us
        </h1>
        <p className=" mt-1 h-[72px] text-center text-[#6e6e6e] text-base font-normal font-['Poppins'] leading-normal">
